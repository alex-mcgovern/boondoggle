...
(self.webpackChunk_alex_mcgovern_boondoggle_design =
	...
	[4339],
	{
		"./src/components/date_picker/index.tsx": (
					...
					children: (0, jsx_runtime.jsxs)(box.x, {
						...
						children: [
							(0, jsx_runtime.jsx)(components_button.z, {
								...
								name: "prev",
								size: "square_md",
								slotLeft: (0, jsx_runtime.jsx)(icon.J, {
									icon: pro_solid_svg_icons.EyR,
								}),
							}),
							(0, jsx_runtime.jsxs)(components_button.z, {
								appearance: "ghost",
								name: "toggle_years",
			...
			try {
				(DatePickerControls.displayName = "DatePickerControls"),
					(DatePickerControls.__docgenInfo = {
						description: "Renders controls for the date picker.",
						displayName: "DatePickerControls",
						props: {
							isShowingYears: {
								defaultValue: null,
								description:
							...
							nextMonthButton: {
								...
								required: !0,
								type: {
									name: "(config?: DPMonthsPropGettersConfig) => DPPropGetter",
								},
							},
							nextYearsButton: {
								defaultValue: null,
								...
								name: "nextYearsButton",
								required: !0,
								type: {
									name: "(config?: DPPropsGetterConfig) => DPPropGetter",
								},
							},
							onToggleYears: {
								defaultValue: null,
							...
							years: {
								defaultValue: null,
								description: "The current years in range.",
								name: "years",
								required: !0,
								type: { name: "DPYear[]" },
							},
					...
					"undefined" != typeof STORYBOOK_REACT_CLASSES &&
						(STORYBOOK_REACT_CLASSES[
							"src/components/date_picker/components/date_picker_controls.comp.tsx#DatePickerControls"
						] = {
							docgenInfo: DatePickerControls.__docgenInfo,
							name: "DatePickerControls",
							path: "src/components/date_picker/components/date_picker_controls.comp.tsx#DatePickerControls",
						});
			} catch (__react_docgen_typescript_loader_error) {}
			const getDayButtonAppearance = ({ now, selected }) =>
				selected ? "primary" : now ? "secondary" : "ghost";
			function DatePickerDays({ dayButton, days, onDayClick }) {
				return (0, jsx_runtime.jsx)(jsx_runtime.Fragment, {
					children: days.map((calendarDay) =>
				...
				(DatePickerDays.displayName = "DatePickerDays"),
					(DatePickerDays.__docgenInfo = {
						...
						props: {
							dayButton: {
								defaultValue: null,
								description: "Props getter for a day button.",
								name: "dayButton",
								required: !0,
								type: {
									name: "(day: DPDay, config?: DPPropsGetterConfig) => DPPropGetter",
								},
							},
							days: {
								defaultValue: null,
								description: "The currently visible days.",
								name: "days",
								required: !0,
								type: { name: "DPDay[]" },
							},
							...
							onDayClick: {
								...
								required: !0,
								type: {
									name: "(evt: MouseEvent<HTMLElement, MouseEvent>, date: Date) => void",
								},
							},
						},
					}),
					"undefined" != typeof STORYBOOK_REACT_CLASSES &&
						(STORYBOOK_REACT_CLASSES[
							"src/components/date_picker/components/date_picker_days.comp.tsx#DatePickerDays"
						] = {
							docgenInfo: DatePickerDays.__docgenInfo,
							name: "DatePickerDays",
							path: "src/components/date_picker/components/date_picker_days.comp.tsx#DatePickerDays",
						});
			} catch (__react_docgen_typescript_loader_error) {}
			function DatePickerYears({ onYearClick, yearButton, years }) {
				return (0, jsx_runtime.jsx)(jsx_runtime.Fragment, {
					children: years.map((calendarYear) =>
						(0, jsx_runtime.jsx)(
							components_button.z,
							{
								appearance: calendarYear.selected
									? "primary"
									: "ghost",
			...
			try {
				(DatePickerYears.displayName = "DatePickerYears"),
					(DatePickerYears.__docgenInfo = {
						description:
							"Renders a grid of year buttons for the date picker.",
						displayName: "DatePickerYears",
						props: {
							onYearClick: {
								defaultValue: null,
								description:
							...
							yearButton: {
								defaultValue: null,
								description: "Props getter for a year button.",
								name: "yearButton",
								required: !0,
								type: {
									name: "(year: DPYear, config?: DPPropsGetterConfig) => DPPropGetter",
								},
							},
							years: {
								defaultValue: null,
					...
					"undefined" != typeof STORYBOOK_REACT_CLASSES &&
						(STORYBOOK_REACT_CLASSES[
							"src/components/date_picker/components/date_picker_years.comp.tsx#DatePickerYears"
						] = {
							docgenInfo: DatePickerYears.__docgenInfo,
							name: "DatePickerYears",
							path: "src/components/date_picker/components/date_picker_years.comp.tsx#DatePickerYears",
						});
			} catch (__react_docgen_typescript_loader_error) {}
			__webpack_require__(
			...
			var injectStylesIntoStyleTag = __webpack_require__(
				...
				styles_css_ts_vanilla_css_source_LnN0eWxlc19kYXRlUGlja2VyUm9vdF9fN2dsbmFhMSB7CiAgbWluLXdpZHRoOiAyNHJlbTsKfQ_node_modules_vanilla_extract_webpack_plugin_extracted =
					__webpack_require__(
			...
			injectStylesIntoStyleTag_default()(
				styles_css_ts_vanilla_css_source_LnN0eWxlc19kYXRlUGlja2VyUm9vdF9fN2dsbmFhMSB7CiAgbWluLXdpZHRoOiAyNHJlbTsKfQ_node_modules_vanilla_extract_webpack_plugin_extracted.Z,
				options,
			);
			styles_css_ts_vanilla_css_source_LnN0eWxlc19kYXRlUGlja2VyUm9vdF9fN2dsbmFhMSB7CiAgbWluLXdpZHRoOiAyNHJlbTsKfQ_node_modules_vanilla_extract_webpack_plugin_extracted.Z &&
				styles_css_ts_vanilla_css_source_LnN0eWxlc19kYXRlUGlja2VyUm9vdF9fN2dsbmFhMSB7CiAgbWluLXdpZHRoOiAyNHJlbTsKfQ_node_modules_vanilla_extract_webpack_plugin_extracted
				...
				styles_css_ts_vanilla_css_source_LnN0eWxlc19kYXRlUGlja2VyUm9vdF9fN2dsbmFhMSB7CiAgbWluLXdpZHRoOiAyNHJlbTsKfQ_node_modules_vanilla_extract_webpack_plugin_extracted
					.Z.locals;
			const DatePicker = (0, react.forwardRef)(
				({ className: userClassName, onDayClick, ...rest }, ref) => {
					const [selectedDates, onDatesChange] = (0, react.useState)(
							[],
						),
						[isShowingYears, setIsShowingYears] = (0,
						react.useState)(!1),
						{
							...
							onDatesChange,
							selectedDates,
							years: { numberOfYears: 20, step: 20 },
						}),
						{ days, month, year } = calendars[0],
						onToggleYears = (0, react.useCallback)(() => {
							setIsShowingYears((prev) => !prev);
						}, []),
						onYearClick = (0, react.useCallback)(() => {
							setIsShowingYears(!1);
						}, []);
					return (0, jsx_runtime.jsxs)(box.x, {
						...
						className: (0, clsx_m.Z)(
							userClassName,
							"styles_datePickerRoot__7glnaa1 get_sprinkles_padding_space_4_mobile__eiij7bdw get_sprinkles_width_max-content_mobile__eiij7bl5",
							color_palette_css.gx.default,
						),
						ref,
						...rest,
						children: [
							(0, jsx_runtime.jsx)(DatePickerControls, {
								isShowingYears,
								month,
								nextMonthButton,
								nextYearsButton,
							...
							(0, jsx_runtime.jsx)(box.x, {
								display: "grid",
								gap: "space_2",
								gridTemplateColumns: isShowingYears
									? "4x"
									: "7x",
								children: isShowingYears
									? (0, jsx_runtime.jsx)(DatePickerYears, {
											onYearClick,
											yearButton,
											years,
									  })
									: (0, jsx_runtime.jsx)(DatePickerDays, {
											dayButton,
											days,
											month,
											onDayClick,
			...
			try {
				(DatePicker.displayName = "DatePicker"),
					...
					"undefined" != typeof STORYBOOK_REACT_CLASSES &&
						(STORYBOOK_REACT_CLASSES[
							"src/components/date_picker/index.tsx#DatePicker"
						] = {
							docgenInfo: DatePicker.__docgenInfo,
							name: "DatePicker",
							path: "src/components/date_picker/index.tsx#DatePicker",
						});
			} catch (__react_docgen_typescript_loader_error) {}
		},
	},
