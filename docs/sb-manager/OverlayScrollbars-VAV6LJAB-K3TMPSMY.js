						...
						EASING = (function () {
							...
							return {
								swing: function (x, t, b, c, d) {
									return (
										0.5 -
										_easingsMath.c(x * _easingsMath.p) / 2
									);
								},
								...
								easeInBounce: function (x, t, b, c, d) {
									return (
										c -
										this.easeOutBounce(x, d - t, 0, c, d) +
										b
									);
								},
							...
							return (
								(FakejQuery[LEXICON.p] = {
									on: function (eventName, handler) {
										eventName = (
											eventName || _strEmpty
										).match(_rnothtmlwhite) || [_strEmpty];
										var eventNameLength =
												eventName[LEXICON.l],
											i = 0,
											el;
...
` + window2.JSON.stringify(objectCopy, null, 2),
								...
								FRAMEWORK.extend(_base, {
									...
									(function () {
										...
										function getWindowDPR() {
											var dDPI =
													window2.screen.deviceXDPI ||
													0,
												sDPI =
													window2.screen
														.logicalXDPI || 1;
											return (
												window2.devicePixelRatio ||
												dDPI / sDPI
											);
										}
							...
							function OverlayScrollbarsAutoUpdateLoop(globals) {
								...
								(_base.add = function (instance) {
									_inArray(instance, _loopingInstances) ===
										-1 &&
							...
							function OverlayScrollbarsInstance(
								...
								var _nativeScrollbarIsOverlaid,
									...
									_classNameScrollbar =
										_cassNamesPrefix + _strScrollbar,
								...
								function isUnknownMutation(mutation) {
									var attributeName = mutation.attributeName,
										...
										strClosest = "closest";
									if (
										mutationTarget === _contentElementNative
									)
								...
								function update(updateHints) {
									...
									if (
										...
										if (
											((_scrollbarsAutoHideNever =
												scrollbarsAutoHide === "n"),
											(_scrollbarsAutoHideScroll =
												scrollbarsAutoHide === "s"),
											(_scrollbarsAutoHideMove =
												scrollbarsAutoHide === "m"),
											(_scrollbarsAutoHideLeave =
												scrollbarsAutoHide === "l"),
											(_scrollbarsAutoHideDelay =
										...
										if (
											((paddingAbsoluteX *=
												paddingAbsolute ? 1 : 0),
											(paddingAbsoluteY *= paddingAbsolute
												? 1
												: 0),
								...
								function setTopRightBottomLeft(
									...
									(prefix = prefix || _strEmpty),
										...
										(targetCSSObject[prefix + _strTop] =
											values[0]),
										(targetCSSObject[prefix + _strRight] =
											values[1]),
										(targetCSSObject[prefix + _strBottom] =
											values[2]),
										(targetCSSObject[prefix + _strLeft] =
											values[3]);
								}
								...
								(_base.sleep = function () {
										...
										if (
											...
											return (
												...
												(scrollX = normalizeInvert
													? maxScrollX - scrollX
													: scrollX),
												(scrollX *= normalizeNegate
													? -1
													: 1),
												(maxScrollX *= normalizeNegate
													? -1
													: 1),
												{
													position: {
										...
										function getRawScroll(
											...
											if (type(coordinates2) == TYPES.o) {
												for (
													i = 0;
													i <
													coordinateProps[strLength];
													i++
												)
													if (
														coordinateProps[i] in
														coordinates2
													)
														return coordinates2[
															coordinateProps[i]
									...
									(_base.getState = function (stateProperty) {
										...
										var obj = {
											...
											heightAuto:
												prepare(_heightAutoCache),
											padding: prepare(_cssPaddingCache),
											overflowAmount:
												prepare(_overflowAmountCache),
											hideOverflow:
												prepare(_hideOverflowCache),
											hasOverflow:
