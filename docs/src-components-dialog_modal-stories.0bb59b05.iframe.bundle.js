...
(self.webpackChunk_alex_mcgovern_boondoggle_design =
	...
	[4131],
	{
		...
		"./src/components/dialog_modal/index.tsx": (
			__unused_webpack_module,
			__webpack_exports__,
			__webpack_require__,
		) => {
			...
			var _radix_ui_react_slot__WEBPACK_IMPORTED_MODULE_12__ =
					__webpack_require__(
						"./node_modules/@radix-ui/react-slot/dist/index.mjs",
					),
				react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
				...
				_loader_full_screen__WEBPACK_IMPORTED_MODULE_10__ =
					__webpack_require__(
							...
							children: [
								triggerNode &&
									...
									react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(
										_radix_ui_react_slot__WEBPACK_IMPORTED_MODULE_12__.g7,
										{
											...
											_dialog_modal_inner__WEBPACK_IMPORTED_MODULE_8__.p,
											{
												...
												children: [
													...
													!isError &&
														...
														(0,
														react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(
															_loader_full_screen__WEBPACK_IMPORTED_MODULE_10__.G,
															{},
														),
													!isError &&
														!isLoading &&
				...
				(DialogModal.displayName = "DialogModal"),
					(DialogModal.__docgenInfo = {
						...
						props: {
							...
							wrapperProps: {
								defaultValue: null,
								description: "Props to pass to the wrapper.",
								name: "wrapperProps",
								required: !1,
								type: { name: "BoxProps" },
							},
					...
					"undefined" != typeof STORYBOOK_REACT_CLASSES &&
						(STORYBOOK_REACT_CLASSES[
							"src/components/dialog_modal/index.tsx#DialogModal"
						] = {
							docgenInfo: DialogModal.__docgenInfo,
							name: "DialogModal",
							path: "src/components/dialog_modal/index.tsx#DialogModal",
						});
			} catch (__react_docgen_typescript_loader_error) {}
		},
		"./src/components/dialog_modal/stories.tsx": (
			...
			__webpack_require__.r(__webpack_exports__),
				__webpack_require__.d(__webpack_exports__, {
					...
					WithAlert: () => WithAlert,
					WithAlertWithColorOverlay: () => WithAlertWithColorOverlay,
					WithConfirmationAction: () => WithConfirmationAction,
					WithConfirmationActionWithColorOverlay: () =>
						WithConfirmationActionWithColorOverlay,
					default: () => __WEBPACK_DEFAULT_EXPORT__,
				});
			var _fortawesome_pro_solid_svg_icons__WEBPACK_IMPORTED_MODULE_10__ =
					__webpack_require__(
				...
				_dialog_info_bullet__WEBPACK_IMPORTED_MODULE_5__ =
					__webpack_require__(
						"./src/components/dialog_info_bullet/index.tsx",
					),
				_dialog_modal_action_confirm__WEBPACK_IMPORTED_MODULE_6__ =
					__webpack_require__(
						"./src/components/dialog_modal_action_confirm/index.tsx",
					),
				_dialog_modal_alert__WEBPACK_IMPORTED_MODULE_7__ =
					__webpack_require__(
						"./src/components/dialog_modal_alert/index.tsx",
					),
				_icon__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
					...
					_box__WEBPACK_IMPORTED_MODULE_3__.x,
					{
						children: Array.from({ length: 8 }).map((_, index) =>
							...
							react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(
								_dialog_info_bullet__WEBPACK_IMPORTED_MODULE_5__.b,
								{
									slotLeft: (0,
									react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(
										_icon__WEBPACK_IMPORTED_MODULE_8__.J,
										{
											icon: _fortawesome_pro_solid_svg_icons__WEBPACK_IMPORTED_MODULE_10__.Kak,
										},
									),
									text: _mocks_LOREM_mock__WEBPACK_IMPORTED_MODULE_2__
										.m.text_lg,
								},
								`key-${index}`,
							),
			...
			const Default = {
					args: {
						...
						title: _mocks_LOREM_mock__WEBPACK_IMPORTED_MODULE_2__.m
							.text_md,
						triggerNode: (0,
						react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(
				...
				WithAlert = {
					args: {
						alert: (0,
						react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(
							_dialog_modal_alert__WEBPACK_IMPORTED_MODULE_7__.t,
							{
								description:
				...
				WithConfirmationAction = {
					args: {
						actions: (0,
						react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(
							_dialog_modal_action_confirm__WEBPACK_IMPORTED_MODULE_6__.P,
							{
