	...
	[3981],
	{
		"./src/components/avatar/index.tsx": (
			...
			var injectStylesIntoStyleTag = __webpack_require__(
				...
				styles_css_ts_vanilla_css_source_LnN0eWxlc19hdmF0YXJTdHlsZV9fMTk5MzJsejEgewogIGZvbnQtc2l6ZTogMTAwJTsKfQ_node_modules_vanilla_extract_webpack_plugin_extracted =
					__webpack_require__(
			...
			injectStylesIntoStyleTag_default()(
				styles_css_ts_vanilla_css_source_LnN0eWxlc19hdmF0YXJTdHlsZV9fMTk5MzJsejEgewogIGZvbnQtc2l6ZTogMTAwJTsKfQ_node_modules_vanilla_extract_webpack_plugin_extracted.Z,
				options,
			);
			styles_css_ts_vanilla_css_source_LnN0eWxlc19hdmF0YXJTdHlsZV9fMTk5MzJsejEgewogIGZvbnQtc2l6ZTogMTAwJTsKfQ_node_modules_vanilla_extract_webpack_plugin_extracted.Z &&
				styles_css_ts_vanilla_css_source_LnN0eWxlc19hdmF0YXJTdHlsZV9fMTk5MzJsejEgewogIGZvbnQtc2l6ZTogMTAwJTsKfQ_node_modules_vanilla_extract_webpack_plugin_extracted
				...
				styles_css_ts_vanilla_css_source_LnN0eWxlc19hdmF0YXJTdHlsZV9fMTk5MzJsejEgewogIGZvbnQtc2l6ZTogMTAwJTsKfQ_node_modules_vanilla_extract_webpack_plugin_extracted
					.Z.locals;
			var avatarStyle =
					"styles_avatarStyle__19932lz1 get_sprinkles_overflowX_hidden__eiij7b99 get_sprinkles_overflowY_hidden__eiij7b9d get_sprinkles_alignItems_center__eiij7b2 get_sprinkles_background_button_active__eiij7bf get_sprinkles_border_border_default__eiij7bt get_sprinkles_borderRadius_50%__eiij7bz get_sprinkles_color_white__eiij7b1t get_sprinkles_display_flex_mobile__eiij7b9z get_sprinkles_flexShrink_0__eiij7b22 get_sprinkles_fontWeight_bold__eiij7b2g get_sprinkles_justifyContent_center__eiij7b3g",
				jsx_runtime = __webpack_require__(
					"./node_modules/react/jsx-runtime.js",
				);
			function Avatar({ firstName, fullName, lastName, size = 64, src }) {
				const initials = (0, react.useMemo)(
					() =>
				...
				(Avatar.displayName = "Avatar"),
					...
					"undefined" != typeof STORYBOOK_REACT_CLASSES &&
						(STORYBOOK_REACT_CLASSES[
							"src/components/avatar/index.tsx#Avatar"
						] = {
							docgenInfo: Avatar.__docgenInfo,
							name: "Avatar",
							path: "src/components/avatar/index.tsx#Avatar",
						});
