	...
	[5146],
	{
		...
		"./documentation/color_palette.mdx": (
			...
			function ColorPalette() {
				return (0, jsx_runtime.jsxs)(dist.VZ, {
					children: [
						(0, jsx_runtime.jsx)(dist.c6, {
							colors: {
								black: theme_css.gR.color.black,
								white: theme_css.gR.color.white,
							},
							subtitle:
								"General purpose neutral colors, that ARE NOT re-assigned by color overlay.",
							title: "Neutral",
						}),
						(0, jsx_runtime.jsx)(dist.c6, {
							colors: {
								background: theme_css.gR.color.background,
							},
							subtitle:
								"Used for page background. Is re-assigned by color overlay.",
							title: "Background",
						}),
						(0, jsx_runtime.jsx)(dist.c6, {
							colors: {
								tint_active: theme_css.gR.color.tint_active,
								tint_default: theme_css.gR.color.tint_default,
							},
							subtitle:
								"Used for tags, cards/surfaces, etc. Is re-assigned by color overlay.",
							title: "Tint",
						}),
						(0, jsx_runtime.jsx)(dist.c6, {
							colors: {
								border_default:
									theme_css.gR.color.border_default,
								border_hover: theme_css.gR.color.border_hover,
							},
							subtitle:
								"Used for borders, dividers, etc. Is re-assigned by color overlay.",
							title: "Border",
						}),
						(0, jsx_runtime.jsx)(dist.c6, {
							colors: {
								button_active: theme_css.gR.color.button_active,
								button_default:
									theme_css.gR.color.button_default,
								button_tint: theme_css.gR.color.button_tint,
							},
							subtitle:
								"Used for buttons, and other use cases requiring a saturated color. Is re-assigned by color overlay. Also used for the focus ring.",
							title: "Button",
						}),
						(0, jsx_runtime.jsx)(dist.c6, {
							colors: {
								text_high_contrast:
									theme_css.gR.color.text_high_contrast,
								text_low_contrast:
									theme_css.gR.color.text_low_contrast,
							},
							subtitle:
								"Used for text. Is re-assigned by color overlay.",
							title: "Text",
						}),
					],
				});
				...
				(ColorPalette.displayName = "ColorPalette"),
					...
					"undefined" != typeof STORYBOOK_REACT_CLASSES &&
						(STORYBOOK_REACT_CLASSES[
							"documentation/color_palette.comp.tsx#ColorPalette"
						] = {
							docgenInfo: ColorPalette.__docgenInfo,
							name: "ColorPalette",
							path: "documentation/color_palette.comp.tsx#ColorPalette",
						});
				...
				return (0, jsx_runtime.jsxs)(jsx_runtime.Fragment, {
					children: [
						...
						(0, jsx_runtime.jsx)(_components.h2, {
							...
							children: "Base color palette",
						}),
						"\n",
						(0, jsx_runtime.jsx)(box.x, {
							className: (0, theme_css.gh)(),
							children: (0, jsx_runtime.jsx)(ColorPalette, {}),
						}),
						"\n",
						(0, jsx_runtime.jsx)(_components.h2, {
							id: "coloroverlay-blue",
							children: "ColorOverlay: Blue",
						}),
						"\n",
						(0, jsx_runtime.jsx)(box.x, {
							className: theme_css.gx.blue,
							children: (0, jsx_runtime.jsx)(ColorPalette, {
						...
						"\n",
						(0, jsx_runtime.jsx)(_components.h2, {
							id: "coloroverlay-amber",
							children: "ColorOverlay: Amber",
						}),
						"\n",
						(0, jsx_runtime.jsx)(box.x, {
							className: theme_css.gx.amber,
							children: (0, jsx_runtime.jsx)(ColorPalette, {
								children: (0, jsx_runtime.jsx)(
									ColorPalette,
									{},
						...
						"\n",
						(0, jsx_runtime.jsx)(_components.h2, {
							id: "coloroverlay-green",
							children: "ColorOverlay: Green",
						}),
						"\n",
						(0, jsx_runtime.jsx)(box.x, {
							className: theme_css.gx.green,
							children: (0, jsx_runtime.jsx)(ColorPalette, {
								children: (0, jsx_runtime.jsx)(
									ColorPalette,
									{},
						...
						(0, jsx_runtime.jsx)(_components.h2, {
							id: "coloroverlay-red",
							children: "ColorOverlay: Red",
						}),
						"\n",
						(0, jsx_runtime.jsx)(box.x, {
							className: theme_css.gx.red,
							children: (0, jsx_runtime.jsx)(ColorPalette, {
								children: (0, jsx_runtime.jsx)(
									ColorPalette,
									{},
			...
			const color_palette = function MDXContent(props = {}) {
