	...
	[5141],
	{
		"./src/components/loader_full_screen/index.tsx": (
			...
			var box = __webpack_require__("./src/components/box/index.tsx"),
				...
				styles_css_ts_vanilla_css_source_LnN0eWxlc19sb2FkZXJXcmFwcGVyU3R5bGVfXzFpaWtsdXUxIHsKICBmbGV4LWdyb3c6IDE7CiAgaGVpZ2h0OiAxMDBkdmg7CiAgbWluLWhlaWdodDogNDB2aDsKfQ_node_modules_vanilla_extract_webpack_plugin_extracted =
					__webpack_require__(
			...
			injectStylesIntoStyleTag_default()(
				styles_css_ts_vanilla_css_source_LnN0eWxlc19sb2FkZXJXcmFwcGVyU3R5bGVfXzFpaWtsdXUxIHsKICBmbGV4LWdyb3c6IDE7CiAgaGVpZ2h0OiAxMDBkdmg7CiAgbWluLWhlaWdodDogNDB2aDsKfQ_node_modules_vanilla_extract_webpack_plugin_extracted.Z,
				options,
			);
			styles_css_ts_vanilla_css_source_LnN0eWxlc19sb2FkZXJXcmFwcGVyU3R5bGVfXzFpaWtsdXUxIHsKICBmbGV4LWdyb3c6IDE7CiAgaGVpZ2h0OiAxMDBkdmg7CiAgbWluLWhlaWdodDogNDB2aDsKfQ_node_modules_vanilla_extract_webpack_plugin_extracted.Z &&
				styles_css_ts_vanilla_css_source_LnN0eWxlc19sb2FkZXJXcmFwcGVyU3R5bGVfXzFpaWtsdXUxIHsKICBmbGV4LWdyb3c6IDE7CiAgaGVpZ2h0OiAxMDBkdmg7CiAgbWluLWhlaWdodDogNDB2aDsKfQ_node_modules_vanilla_extract_webpack_plugin_extracted
				...
				styles_css_ts_vanilla_css_source_LnN0eWxlc19sb2FkZXJXcmFwcGVyU3R5bGVfXzFpaWtsdXUxIHsKICBmbGV4LWdyb3c6IDE7CiAgaGVpZ2h0OiAxMDBkdmg7CiAgbWluLWhlaWdodDogNDB2aDsKfQ_node_modules_vanilla_extract_webpack_plugin_extracted
					.Z.locals;
			var loaderWrapperStyle =
					"styles_loaderWrapperStyle__1iikluu1 get_sprinkles_marginTop_auto__eiij7b5f get_sprinkles_marginBottom_auto__eiij7b49 get_sprinkles_alignItems_center__eiij7b2 get_sprinkles_display_flex_mobile__eiij7b9z get_sprinkles_flexDirection_column_mobile__eiij7baq get_sprinkles_gap_space_4_mobile__eiij7bbn get_sprinkles_justifyContent_center__eiij7b3g get_sprinkles_padding_space_8_mobile__eiij7be5 get_sprinkles_width_100%_mobile__eiij7bjn",
			...
			function LoaderFullScreen({
				...
				return (0, jsx_runtime.jsxs)(box.x, {
					...
					...rest,
					children: [
						(0, jsx_runtime.jsx)(loader.a, { color, size: "3x" }),
						loadingText &&
			...
			try {
				(LoaderFullScreen.displayName = "LoaderFullScreen"),
					(LoaderFullScreen.__docgenInfo = {
						description:
							"Full-screen version of the loader component.",
						displayName: "LoaderFullScreen",
						props: {
							loadingText: {
								defaultValue: null,
								description: "Text shown underneath loader.",
								name: "loadingText",
								required: !1,
								type: { name: "string" },
							},
							...
							color: {
								defaultValue: { value: "text_low_contrast" },
								description: "",
								name: "color",
								required: !1,
								type: {
					...
					"undefined" != typeof STORYBOOK_REACT_CLASSES &&
						(STORYBOOK_REACT_CLASSES[
							"src/components/loader_full_screen/index.tsx#LoaderFullScreen"
						] = {
							docgenInfo: LoaderFullScreen.__docgenInfo,
							name: "LoaderFullScreen",
							path: "src/components/loader_full_screen/index.tsx#LoaderFullScreen",
						});
