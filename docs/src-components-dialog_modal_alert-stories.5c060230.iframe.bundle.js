...
(self.webpackChunk_alex_mcgovern_boondoggle_design =
	...
	[4749],
	{
		...
		"./src/components/dialog_modal_alert/index.tsx": (
			__unused_webpack_module,
			__webpack_exports__,
			__webpack_require__,
		) => {
			...
			var pro_solid_svg_icons = __webpack_require__(
				...
				dialogModalAlertSlotStyle =
					"get_sprinkles_color_text_low_contrast__eiij7b1p get_sprinkles_flexShrink_0__eiij7b22 get_sprinkles_width_space_4_mobile__eiij7blw",
				getDialogModalAlertWrapperStyles = (0,
				vanilla_extract_recipes_createRuntimeFn_esm.u)({
					defaultClassName:
						"get_sprinkles_alignItems_center__eiij7b2 get_sprinkles_background_tint_default__eiij7bo get_sprinkles_borderBottom_border_default__eiij7bv get_sprinkles_display_flex_mobile__eiij7b9z get_sprinkles_gap_space_4_mobile__eiij7bbn get_sprinkles_padding_space_4_mobile__eiij7bdw",
					variantClassNames: {
						colorOverlay: {
			...
			function DialogModalAlert({
				...
				return (0, jsx_runtime.jsxs)(box.x, {
					className: getDialogModalAlertWrapperStyles({
						colorOverlay,
					}),
					children: [
						slotLeft &&
							(0, jsx_runtime.jsx)(box.x, {
								className: dialogModalAlertSlotStyle,
			...
			try {
				(DialogModalAlert.displayName = "DialogModalAlert"),
					(DialogModalAlert.__docgenInfo = {
						description:
							"Renders an inline alert for use ina  Dialog component.",
						displayName: "DialogModalAlert",
						props: {
							slotLeft: {
								defaultValue: {
									value: "[<Icon icon={faInfoCircle} />]",
								},
								description:
					...
					"undefined" != typeof STORYBOOK_REACT_CLASSES &&
						(STORYBOOK_REACT_CLASSES[
							"src/components/dialog_modal_alert/index.tsx#DialogModalAlert"
						] = {
							docgenInfo: DialogModalAlert.__docgenInfo,
							name: "DialogModalAlert",
							path: "src/components/dialog_modal_alert/index.tsx#DialogModalAlert",
						});
			} catch (__react_docgen_typescript_loader_error) {}
		},
					...
					args: {
						description:
							_mocks_LOREM_mock__WEBPACK_IMPORTED_MODULE_1__.m
								.text_md,
						title: _mocks_LOREM_mock__WEBPACK_IMPORTED_MODULE_1__.m
							.text_xxs,
					},
					component: ___WEBPACK_IMPORTED_MODULE_0__.t,
					title: "Components/DialogModalAlert",
				},
				Default = {},
				Red = { args: { colorOverlay: "red" } },
				Blue = { args: { colorOverlay: "blue" } },
				Green = { args: { colorOverlay: "green" } },
				Grey = { args: { colorOverlay: "grey" } };
		},
