			...
			const $faa2e61a3361514f$var$PAGE_KEYS = ["PageUp", "PageDown"],
				...
				[
					...
					const PROVIDER_NAME = name + "CollectionProvider",
						...
						react_context_dist.b)(PROVIDER_NAME),
						...
						CollectionSlot = react.forwardRef(
							(props, forwardedRef) => {
								const { scope, children } = props,
				...
				react.forwardRef)((props, forwardedRef) => {
					const {
						...
						[slider, setSlider] = (0, react.useState)(null),
						composedRefs = (0, react_compose_refs_dist.e)(
							forwardedRef,
							(node) => setSlider(node),
						),
						thumbRefs = (0, react.useRef)(new Set()),
						valueIndexToChangeRef = (0, react.useRef)(0),
						...
						valuesBeforeSlideStartRef = (0, react.useRef)(values);
					function updateValues(
						...
						setValues((prevValues = []) => {
							...
							if (
								...
								const hasChanged =
									String(nextValues) !== String(prevValues);
								return (
									hasChanged &&
										commit &&
				...
				$faa2e61a3361514f$var$SliderHorizontal = (0, react.forwardRef)(
					(props, forwardedRef) => {
						const {
								min,
								max,
							...
							rectRef = (0, react.useRef)(),
							direction =
								(function $f631663db3294ace$export$b39126d51d94e6f3(
									localDir,
								) {
									const globalDir = (0, react.useContext)(
				...
				$faa2e61a3361514f$var$SliderVertical = (0, react.forwardRef)(
					(props, forwardedRef) => {
						const {
								min,
								max,
				...
				$faa2e61a3361514f$var$SliderImpl = (0, react.forwardRef)(
					(props, forwardedRef) => {
						const {
								__scopeSlider,
								onSlideStart,
				...
				react.forwardRef)((props, forwardedRef) => {
					const getItems = $faa2e61a3361514f$var$useCollection(
						...
						[thumb, setThumb] = (0, react.useState)(null),
						composedRefs = (0, react_compose_refs_dist.e)(
							forwardedRef,
							(node) => setThumb(node),
						),
				...
				$faa2e61a3361514f$var$SliderThumbImpl = (0, react.forwardRef)(
					(props, forwardedRef) => {
						const { __scopeSlider, index, ...thumbProps } = props,
							...
							size =
								(function $db6c3485150b8e66$export$1ab7ae714698c4b8(
									...
									return (
										(0,
										react_use_layout_effect_dist.b)(() => {
											if (element) {
												setSize({
			...
			(module, __webpack_exports__, __webpack_require__) => {
				...
				___CSS_LOADER_EXPORT___.push([
					...
					"",
					{
						...
						names: [],
						mappings:
							"AAAA;EACE,kBAAkB;EAClB,iBAAiB;AACnB;AACA;EACE,yCAAyC;AAC3C;AACA;EACE,sBAAsB;EACtB,wCAAwC;AAC1C;AACA;EACE,2CAA2C;EAC3C,YAAY;AACd;AACA;EACE,yCAAyC;AAC3C;AACA;EACE,wCAAwC;AAC1C;AACA;EACE,wCAAwC;EACxC,2CAA2C;EAC3C,eAAe;AACjB;AACA;EACE,yCAAyC;EACzC,+CAA+C;EAC/C,6CAA6C;AAC/C;AACA;EACE;IACE,oIAAoI;EACtI;AACF",
						sourcesContent: [
							".styles_sliderRoot__oj3mu21 {\n  touch-action: none;\n  user-select: none;\n}\n.styles_sliderRoot__oj3mu21[data-orientation='horizontal'] {\n  height: var(--spacing-space_6__1k9lq962e);\n}\n.styles_sliderRoot__oj3mu21[data-orientation='vertical'] {\n  flex-direction: column;\n  width: var(--spacing-space_6__1k9lq962e);\n}\n.styles_sliderTrack__oj3mu23 {\n  background: var(--border_default__13r5x7f4);\n  flex-grow: 1;\n}\n.styles_sliderTrack__oj3mu23[data-orientation='horizontal'] {\n  height: var(--spacing-space_1__1k9lq9629);\n}\n.styles_sliderTrack__oj3mu23[data-orientation='vertical'] {\n  width: var(--spacing-space_1__1k9lq9629);\n}\n.styles_sliderThumb__oj3mu27:is(:hover) {\n  background: var(--tint_active__13r5x7fe);\n  border-color: var(--border_hover__13r5x7f5);\n  cursor: pointer;\n}\n.styles_sliderThumb__oj3mu27:is(:focus-visible) {\n  box-shadow: var(--boxShadow-md__1k9lq96c);\n  outline: 1px solid var(--focus_ring__13r5x7fa) ;\n  border-color: var(--button_default__13r5x7f7);\n}\n@media (prefers-reduced-motion: no-preference) {\n  .styles_sliderThumb__oj3mu27 {\n    transition: background var(--transitionDuration-short__1k9lq962k) ease, border-color var(--transitionDuration-short__1k9lq962k) ease;\n  }\n}",
						],
						sourceRoot: "",
