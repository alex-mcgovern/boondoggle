...
(self.webpackChunk_alex_mcgovern_boondoggle_design =
	...
	[8442],
	{
		"./src/components/icon_flag/styles.css.ts": (
			__unused_webpack_module,
			__webpack_exports__,
			__webpack_require__,
		) => {
			__webpack_require__.d(__webpack_exports__, { h: () => flagStyles });
			__webpack_require__(
			...
			var flagStyles =
				"get_sprinkles_aspectRatio_square__eiij7b6 get_sprinkles_border_border_default__eiij7bt get_sprinkles_borderRadius_50%__eiij7bz get_sprinkles_flexShrink_0__eiij7b22";
		},
		...
		"./src/components/icon_flag/flags/ie.tsx": (
			__unused_webpack_module,
			__webpack_exports__,
			__webpack_require__,
		) => {
			__webpack_require__.d(__webpack_exports__, { O: () => FlagIe });
			var clsx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
				...
				_styles_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
					"./src/components/icon_flag/styles.css.ts",
				),
			...
			function FlagIe({
				...
				return (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(
					...
					{
						as: "svg",
						className: (0, clsx__WEBPACK_IMPORTED_MODULE_4__.Z)(
							_styles_css__WEBPACK_IMPORTED_MODULE_2__.h,
							(0,
							_styles_utils_get_sprinkles_css__WEBPACK_IMPORTED_MODULE_0__.eD)(
								{ height, width, ...rest },
							),
						),
						viewBox: "0 0 512 512",
			...
			try {
				(FlagIe.displayName = "FlagIe"),
					...
					"undefined" != typeof STORYBOOK_REACT_CLASSES &&
						(STORYBOOK_REACT_CLASSES[
							"src/components/icon_flag/flags/ie.tsx#FlagIe"
						] = {
							docgenInfo: FlagIe.__docgenInfo,
							name: "FlagIe",
							path: "src/components/icon_flag/flags/ie.tsx#FlagIe",
						});
			} catch (__react_docgen_typescript_loader_error) {}
		},
