		...
		"./src/components/button/stories.tsx": (
			...
			__webpack_require__.r(__webpack_exports__),
				__webpack_require__.d(__webpack_exports__, {
					...
					AppearanceSecondary: () => AppearanceSecondary,
					AsAnchorTag: () => AsAnchorTag,
					AsLinkComponent: () => AsLinkComponent,
					ColorOverlayAmber: () => ColorOverlayAmber,
					ColorOverlayBlue: () => ColorOverlayBlue,
					ColorOverlayGreen: () => ColorOverlayGreen,
					ColorOverlayGrey: () => ColorOverlayGrey,
					ColorOverlayRed: () => ColorOverlayRed,
					Default: () => Default,
					IsLoading: () => IsLoading,
					SizeLg: () => SizeLg,
					SizeMd: () => SizeMd,
					SizeSm: () => SizeSm,
					SizeSquareLg: () => SizeSquareLg,
					SizeSquareMd: () => SizeSquareMd,
					SizeSquareSm: () => SizeSquareSm,
			...
			var _fortawesome_pro_solid_svg_icons__WEBPACK_IMPORTED_MODULE_4__ =
				...
				_test_link_comp_mock__WEBPACK_IMPORTED_MODULE_1__ =
			...
			const __WEBPACK_DEFAULT_EXPORT__ = {
				...
				Default = {},
				AsAnchorTag = { args: { as: "a", href: "/" } },
				AsLinkComponent = {
					args: {
						as: _test_link_comp_mock__WEBPACK_IMPORTED_MODULE_1__.r,
						href: "/",
					},
				},
				AppearancePrimary = { args: { appearance: "primary" } },
				AppearanceSecondary = { args: { appearance: "secondary" } },
				AppearanceGhost = { args: { appearance: "ghost" } },
				AppearanceLink = { args: { appearance: "link" } },
				ColorOverlayBlue = { args: { colorOverlay: "blue" } },
				ColorOverlayRed = { args: { colorOverlay: "red" } },
				ColorOverlayGreen = { args: { colorOverlay: "green" } },
				ColorOverlayAmber = { args: { colorOverlay: "amber" } },
				ColorOverlayGrey = { args: { colorOverlay: "grey" } },
				IsLoading = { args: { isLoading: !0 } },
				SizeSm = { args: { size: "sm" } },
				SizeMd = { args: { size: "md" } },
				SizeLg = { args: { size: "lg" } },
				SizeSquareSm = { args: { size: "square_sm" } },
				SizeSquareMd = { args: { size: "square_md" } },
				SizeSquareLg = { args: { size: "square_md" } },
				With1SlotLeft = {
					args: {
						slotLeft: (0,
						react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(
							...
							{
								icon: _fortawesome_pro_solid_svg_icons__WEBPACK_IMPORTED_MODULE_4__.eFW,
							},
						),
					},
				},
				...
				WithTooltip = {
					args: { strTooltip: "Tooltip", tooltipPlacement: "top" },
				},
				With1SlotRight = {
					args: {
						slotRight: (0,
