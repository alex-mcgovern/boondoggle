	...
	[5277],
	{
		...
		"./src/components/progress_bar/index.tsx": (
			...
			var clsx_m = __webpack_require__(
				...
				styles_css_ts_vanilla_css_source_LnN0eWxlc19wcm9ncmVzc0JhcklubmVyU3R5bGVzX19xanIwZmFjIHsKICBpbnNldDogMDsKICBwb3NpdGlvbjogYWJzb2x1dGU7Cn0_node_modules_vanilla_extract_webpack_plugin_extracted =
					__webpack_require__(
			...
			injectStylesIntoStyleTag_default()(
				styles_css_ts_vanilla_css_source_LnN0eWxlc19wcm9ncmVzc0JhcklubmVyU3R5bGVzX19xanIwZmFjIHsKICBpbnNldDogMDsKICBwb3NpdGlvbjogYWJzb2x1dGU7Cn0_node_modules_vanilla_extract_webpack_plugin_extracted.Z,
				options,
			);
			styles_css_ts_vanilla_css_source_LnN0eWxlc19wcm9ncmVzc0JhcklubmVyU3R5bGVzX19xanIwZmFjIHsKICBpbnNldDogMDsKICBwb3NpdGlvbjogYWJzb2x1dGU7Cn0_node_modules_vanilla_extract_webpack_plugin_extracted.Z &&
				styles_css_ts_vanilla_css_source_LnN0eWxlc19wcm9ncmVzc0JhcklubmVyU3R5bGVzX19xanIwZmFjIHsKICBpbnNldDogMDsKICBwb3NpdGlvbjogYWJzb2x1dGU7Cn0_node_modules_vanilla_extract_webpack_plugin_extracted
				...
				styles_css_ts_vanilla_css_source_LnN0eWxlc19wcm9ncmVzc0JhcklubmVyU3R5bGVzX19xanIwZmFjIHsKICBpbnNldDogMDsKICBwb3NpdGlvbjogYWJzb2x1dGU7Cn0_node_modules_vanilla_extract_webpack_plugin_extracted
					.Z.locals;
			var getProgressBarStyles = (0,
				__webpack_require__(
					"./node_modules/@vanilla-extract/recipes/createRuntimeFn/dist/vanilla-extract-recipes-createRuntimeFn.esm.js",
				).u)({
					defaultClassName:
						"color_palette_variantColorOverlay_blue__13r5x7fj get_sprinkles_overflowX_hidden__eiij7b99 get_sprinkles_overflowY_hidden__eiij7b9d get_sprinkles_paddingLeft_space_2_mobile__eiij7bg2 get_sprinkles_paddingRight_space_2_mobile__eiij7bh8 get_sprinkles_paddingTop_space_1_mobile__eiij7bib get_sprinkles_paddingBottom_space_1_mobile__eiij7bet get_sprinkles_alignItems_center__eiij7b2 get_sprinkles_border_border_hover__eiij7bu get_sprinkles_borderRadius_sm__eiij7b13 get_sprinkles_color_text_low_contrast__eiij7b1p get_sprinkles_display_flex_mobile__eiij7b9z get_sprinkles_fontWeight_medium__eiij7b2j get_sprinkles_justifyContent_center__eiij7b3g get_sprinkles_minWidth_space_12__eiij7b98 get_sprinkles_position_relative_mobile__eiij7bj2 get_sprinkles_whiteSpace_nowrap__eiij7b9s",
					variantClassNames: {
						size: {
				...
				progressBarInnerStyles =
					"styles_progressBarInnerStyles__qjr0fac get_sprinkles_background_tint_active__eiij7bn",
			...
			function ProgressBar({
				...
				const parsedValue =
					...
					clampedValue = Math.min(100, Math.max(0, parsedValue));
				return (0, jsx_runtime.jsxs)(box.x, {
					className: (0, clsx_m.Z)(
						userClassName,
						getProgressBarStyles({ size }),
					),
					...rest,
					children: [
						isVisible &&
						...
						(0, jsx_runtime.jsx)(box.x, {
							...
							className: progressBarInnerStyles,
				...
				(ProgressBar.displayName = "ProgressBar"),
					(ProgressBar.__docgenInfo = {
						...
						props: {
							...
							value: {
								defaultValue: null,
								description: "A number within the range 0-100",
								name: "value",
								required: !0,
								type: { name: "number" },
							},
					...
					"undefined" != typeof STORYBOOK_REACT_CLASSES &&
						(STORYBOOK_REACT_CLASSES[
							"src/components/progress_bar/index.tsx#ProgressBar"
						] = {
							docgenInfo: ProgressBar.__docgenInfo,
							name: "ProgressBar",
							path: "src/components/progress_bar/index.tsx#ProgressBar",
						});
			} catch (__react_docgen_typescript_loader_error) {}
		},
		"./src/components/progress_bar/stories.tsx": (
			...
			const __WEBPACK_DEFAULT_EXPORT__ = {
				...
				VisibleValue = { args: { isVisible: !0, value: 50 } },
				Max = { args: { value: 100 } },
				String = { args: { value: "50" } },
				OverMax = { args: { value: 120 } },
				Float = { args: { value: 120 } },
				Min = { args: { value: 0 } },
				OverMin = { args: { value: -10 } };
		},
		"./node_modules/clsx/dist/clsx.m.js": (
			__unused_webpack_module,
			__webpack_exports__,
