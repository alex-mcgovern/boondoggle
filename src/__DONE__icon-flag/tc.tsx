...
export function FlagTc({
	...
	return (
		...
		>
			<path d="M512 512V0H0v512z" fill="#002868" />
			<g fill="none" stroke="#000">
				...
				>
					...
					/>
					<path
						d="M344.4 265.5c-1.4-3.3-2.9-6.5.7-13.5 3.8-7.1 1.4-12.5.3-16.1-1.1-3.5-1.4-6.8 0-8.3 1.5-1.3 2.1-2.2 2.2-4.6.1-2.3 2-1.5 2.3-.4s.5 3-1.5 6.4c-2 3.5 5.6 12 2.1 21.1-2.4 6.4.8 14.5 2 20.2s2 19-6.3 21c5.7-2.7.4-20.6-1.8-25.8Z"
						fill="#f1b2dc"
						strokeWidth={0.3}
					/>
					<path
						d="M307.3 264.5c1.3.3 2-.5 2.4-1.4s.7-1.4 2-1.5c1.2 0 3.2-.4 3.7-1.4.4-1 1.9 0 3.2-2.6 1.3-2.6 2.1-5.6 5.5-6.7m9.3-21.8c-1.3 0-4.9.2-6.4 3.4m-10.4-18.9c3 .9 1.8 2.9 3.3 4 2.7 2.2.2 4.4 2.5 5s2.1 1 1.6 3.5c-.8 2.9 2 3 1 4.9m-13 9.9c1.8-1.7 6.1-2.9 7.1-4.7m-7.2-4c2.6 0 6.1 1 6.6 0m-7-2.8c1.3 0 3.9-.9 4.4-2.7m-6.3-1.3a9 9 0 0 0 5.3-1.5m-7.3-3.4c1.1-.9 3.1.1 5-1.1m-3.1-4.9c.9 0 2.8-.3 2.8.9"
						strokeWidth={0.3}
					/>
					<g
						fill="#9e540a"
						transform="matrix(.125 0 0 .125 436 266.5)"
					>
						<g id="tc_svg__b">
					...
					<g transform="matrix(.125 0 0 .125 386 316.5)">
						<g id="tc_svg__d">
							<path
			...
			<path d="M0-.5h256v256H0Z" fill="#012169" />
			<path
			...
			<path
				...
				fill="#c8102e"
			/>
			<path d="M88-.5v256h80V-.5zm-88 88v80h256v-80z" fill="#fff" />
			<path d="M0 103.5v48h256v-48zM104-.5v256h48V-.5z" fill="#c8102e" />
		</Box>
	);
}
