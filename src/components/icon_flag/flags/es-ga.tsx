...
export function FlagEsGa({ height = "space_8", width = "space_8", ...rest }: SprinklesArgs) {
    return (
        <Box
            as="svg"
        ...
        >
            ...
            <g fontSize={12}>
                ...
                />
                <path
                    d="M199 141.6a3 3 0 1 0 0-6 3 3 0 0 0 0 6"
                    fill="#fff"
                />
                <path
                ...
                />
                <path
                    d="M221 137a3 3 0 1 0 0-6 3 3 0 0 0 0 6"
                    fill="#fff"
                />
                <path
                ...
                />
                <path
                    d="M299 139.8a3 3 0 1 0 0-6 3 3 0 0 0 0 6"
                    fill="#fff"
                />
                <path
                ...
                />
                <path
                    d="M235.1 136a3 3 0 1 0 0-6 3 3 0 0 0 0 6"
                    fill="#fff"
                />
                <path
                ...
                />
                <path
                    d="M230 138a3 3 0 1 0 0-6 3 3 0 0 0 0 6"
                    fill="#fff"
                />
                <path
                ...
                />
                <path
                    d="M251.6 146a3 3 0 1 0 0-6 3 3 0 0 0 0 6"
                    fill="#fff"
                />
                <path
                ...
                />
                <path
                    d="M271 135.3a3 3 0 1 0 0-6 3 3 0 0 0 0 6"
                    fill="#fff"
                />
                <path
                ...
                />
                <path
                    d="M280 142.2a3 3 0 1 0 0-6 3 3 0 0 0 0 6"
                    fill="#fff"
                />
                <path
                ...
                />
                <path
                    d="m205.9 201 4.8-3.9-5.4-1s.7.8.6 1.6v3.4"
                    fill="red"
                />
                <path
