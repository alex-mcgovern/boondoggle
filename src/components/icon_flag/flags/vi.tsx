...
export function FlagVi({ height = "space_8", width = "space_8", ...rest }: SprinklesArgs) {
    return (
        <Box
            as="svg"
        ...
        >
            ...
            />
            <path
                d="m379.7 272.7-6.9-4-11.4 49.5-4.7-3.4 11.1-47.4-7.8.2 18.5-33.8 1.2 39zm27 13.4-4.3-7-34.4 40.7-3.7-4.2 34.3-40-7-3.8 31.4-20.7-16.3 35z"
                fill="#0081c6"
                stroke="#010002"
                strokeMiterlimit={10}
                strokeWidth={1.2}
            />
            <path
                d="m399.8 263.4-5.7-5.8-30.8 59.2-4.7-2.8 31-59-7.6-2 26.1-27.6-8.4 38zm-44.1 71.5-2.3 9.4 6.3 6.3-9 37.6-7.9-10.6-11.7 5.5 9-37.7 8.2-2.3 2.1-9.4s2.5-1 5.3 1.2z"
                fill="#0081c6"
                stroke="#010002"
                strokeMiterlimit={10}
                strokeWidth={1.2}
