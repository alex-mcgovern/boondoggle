...
export function FlagFk({ height = "space_8", width = "space_8", ...rest }: SprinklesArgs) {
    return (
        <Box
            as="svg"
        ...
        >
            ...
            <path
                ...
                stroke="#000"
                strokeWidth={1.5}
                transform="matrix(.952 0 0 .952 -322.6 18)"
            />
            <path
                d="m467.8 625.5 7.2-11.9-3.6-2.5c-1 3-5.1 4-5.8 7.8-.7 3.8 2.8 7.5 2.2 6.6z"
                fill="url(#fk_svg__h)"
                fillRule="evenodd"
                stroke="#000"
                strokeWidth={1.2}
