...
export function FlagHk({ height = "space_8", width = "space_8", ...rest }: SprinklesArgs) {
    return (
        <Box
            as="svg"
        ...
        >
            ...
            />
            <use
                transform="rotate(72 248.5 259.5)"
                xlinkHref="#hk_svg__a"
            />
            <use
                transform="rotate(144 248.5 259.5)"
                xlinkHref="#hk_svg__a"
            />
            <use
                transform="rotate(216 248.5 259.5)"
                xlinkHref="#hk_svg__a"
            />
            <use
                transform="rotate(288 248.5 259.5)"
                xlinkHref="#hk_svg__a"
            />
        </Box>
    );
