...
export function FlagGu({
	...
	return (
		...
		>
			<path d="M0 0h512v512H0z" fill="#be0027" fillRule="evenodd" />
			<path
			...
			/>
			<path
				d="M251.9 396.1c1.8 1 4.7 1 6.3.1 103.3-55 103.4-205.8.1-260a7.5 7.5 0 0 0-6.6.1c-100.7 55.1-101 204.2.2 259.8z"
				fill="#cbe0e5"
				fillRule="evenodd"
			/>
			<path
			...
			/>
			<path
				d="m242.4 305.1 87-.4 1.6-7.7-5.6-.6c-3.2-.2-8.5 3.3-12.1 3.3-2.6 0-5.5-4.6-8-4.5-4.4 0-4.8 4-9 4-3.4 0-4.8-2.6-9.2-2.4-4.6.3-4.2 2.8-10 2.7-7.7-.2-10.7-6.9-16.8-7-10.3 0-10.6 9.8-17.9 12.6z"
				fill="#179a3b"
				fillRule="evenodd"
			/>
			<path
				d="m242.4 307 89.6-.5v-2.4l-91.6.5 2 2.4z"
				fill="#fdf9a1"
				fillRule="evenodd"
			/>
			<path
			...
			<path
				...
				fillRule="evenodd"
			/>
			<path d="M238.7 319.8h3.6v6h-3.6z" fillRule="evenodd" />
			<path
			...
			<path
				aria-label="G"
				d="M218.7 255.7q2.6 0 4.5 1 2.7 1.4 3.3 5h-2.4q-.5-2-2-3-1.3-.9-3.5-.9-2.5 0-4.3 2-1.7 1.9-1.7 5.7 0 3.2 1.4 5.3 1.5 2 4.7 2 2.5 0 4.1-1.4 1.7-1.4 1.7-4.7h-5.7v-2h8v9.8h-1.6l-.6-2.4q-1.2 1.4-2.2 2-1.7.9-4.2.9-3.2 0-5.6-2.1-2.6-2.7-2.6-7.3t2.5-7.3q2.4-2.6 6.2-2.6zm-.4 0z"
				fill="#bd0728"
				fontFamily="helvetica"
				fontSize={25.6}
			/>
			<path
				aria-label="U"
				d="M236.5 256.2v11.4q0 2 .7 3.3 1.1 2 3.8 2 3.1 0 4.3-2.1.6-1.2.6-3.2v-11.4h2.5v10.4q0 3.3-1 5.2-1.6 3.3-6.2 3.3-4.7 0-6.4-3.3-.9-1.9-.9-5.2v-10.4zm4.7 0z"
				fill="#bd0728"
				fontFamily="helvetica"
				fontSize={25.6}
			/>
