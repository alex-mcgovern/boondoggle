...
export function FlagMy({ height = "space_8", width = "space_8", ...rest }: SprinklesArgs) {
    return (
        <Box
            as="svg"
        ...
        >
            ...
            />
            <path
                d="M0 73.1h512v36.6H0z"
                fill="#C00"
            />
            <path
                d="M0 109.7h512v36.6H0z"
                fill="#fff"
            />
            <path
                d="M0 146.3h512v36.6H0z"
                fill="#C00"
            />
            <path
                d="M0 182.9h512v36.5H0z"
                fill="#fff"
            />
            <path
                d="M0 219.4h512V256H0z"
                fill="#C00"
            />
            <path
                d="M0 256h512v36.6H0z"
                fill="#fff"
            />
            <path
                d="M0 292.6h512V329H0z"
                fill="#C00"
            />
            <path
                d="M0 329.1h512v36.6H0z"
                fill="#fff"
            />
            <path
                d="M0 365.7h512v36.6H0z"
                fill="#C00"
            />
            <path
                d="M0 402.3h512v36.6H0z"
                fill="#fff"
            />
            <path
                d="M0 438.9h512v36.5H0z"
                fill="#C00"
            />
            <path
                d="M0 475.4h512V512H0z"
                fill="#fff"
            />
            <path
