	...
	return (
		...
		>
			...
			<g clipPath="url(#tw_svg__a)">
				<path d="M0 0h768v512H0z" fill="red" />
				<path d="M0 0h384v256H0z" fill="#000095" />
				<g fill="#fff">
				...
				<circle cx={192} cy={128} fill="#000095" r={54.4} />
				<circle cx={192} cy={128} fill="#fff" r={48} />
			</g>
		</Box>
	);
}
