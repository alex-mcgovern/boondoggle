...
export function FlagVu({ height = "space_8", width = "space_8", ...rest }: SprinklesArgs) {
    return (
        <Box
            as="svg"
        ...
        >
            ...
            />
            <g
                clipPath="url(#vu_svg__a)"
                transform="scale(.56889 1.0779)"
            >
                <path
            ...
            <g
                fill="#fdce12"
                transform="translate(-35.6 26.7) scale(.96552)"
            >
