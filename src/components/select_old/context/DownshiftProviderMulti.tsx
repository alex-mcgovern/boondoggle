...
interface DownshiftProviderMultiProps {
  ...
  onSelectItem?(item: DropdownItemShape | null | undefined): void;
...
export function DownshiftProviderMulti({
  ...
  const [selectedItems, setSelectedItems] = useState<
    (DropdownItemShape | null | undefined)[]
  >(
  ...
  const getIsDropdownItemSelected = useCallback(
    (item: DropdownItemShape | null | undefined) => {
      return (
        selectedItems &&
  ...
  const { getDropdownProps, getSelectedItemProps } =
    useMultipleSelection<DropdownItemShape>({
      selectedItems: selectedItems as Array<DropdownItemShape>,
    });
