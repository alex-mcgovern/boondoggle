...
const outerSize = styleVariants({
  lg: [elementFontSize.lg, elementPaddingLeft.lg],
  md: [elementFontSize.md, elementPaddingLeft.md],
  sm: [elementFontSize.sm, elementPaddingLeft.sm],
});
...
export const getTextAreaWrapperStyles = recipe({
  base: [
    {
...
export const getTextAreaInnerStyles = recipe({
  base: [
    getSprinkles({
      width: "100%",
    }),
