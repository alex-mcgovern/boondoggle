...
type FieldActionButtonClearProps = { strClear?: string } & Omit<
 ...
 */
export function FieldActionButtonClear({ onClick, size, strClear }: FieldActionButtonClearProps) {
    return (
        <FieldActionButton
            name="clear"
            onClick={onClick}
