		...
		>
			<defs>
				<clipPath id="mw_svg__a">
					<path d="M179.7 0h708.7v708.7H179.7z" fillOpacity={0.7} />
				</clipPath>
			</defs>
			<g
				clipPath="url(#mw_svg__a)"
				fillRule="evenodd"
				strokeWidth="1pt"
				transform="translate(-129.8) scale(.72249)"
			>
				<path d="M0 0h1063v708.7H0z" fill="#f41408" />
				<path d="M0 472.4h1063v236.3H0z" fill="#21873b" />
				...
				/>
				<path
					d="M365.5 223.8c-32.5-2.5-67-9.9-72.6-12-5.6-2-5.9-5.4-5.2-8a7 7 0 0 1 8.5-4.5c7.9 2 39.9 10.5 69.3 24.5z"
					fill="#f31509"
				/>
