		...
		>
			<defs>
				<clipPath id="ki_svg__a">
					<path d="M161.8 5.8h491.7v491.6H161.8z" fillOpacity={0.7} />
				</clipPath>
			</defs>
			<g
				clipPath="url(#ki_svg__a)"
			...
			>
				...
				/>
				<path
					d="m526.2 255-107.6 2.4 4.5 29 103.1-31.3z"
					fill="#fec74a"
					fillRule="evenodd"
					stroke="#d8aa3f"
					strokeWidth={1.6}
				/>
				<path
					d="m510.4 215.5-99.7 38.3 16.7 32 83-70.3z"
					fill="#fec74a"
					fillRule="evenodd"
					stroke="#d8aa3f"
					strokeWidth={1.6}
				/>
				<path
					d="m431.2 275.3 51.6-93.7-79.1 73.6 27.5 20z"
					fill="#fec74a"
					fillRule="evenodd"
					stroke="#d8aa3f"
					strokeWidth={1.6}
				/>
				<path
					d="m381.9 573.2-13.5-82.6-15.4 82.6h28.9z"
					fill="#fec74a"
					fillRule="evenodd"
					stroke="#d8aa3f"
					strokeWidth={1.3}
				...
				/>
				<path
					d="m424 259-17.4-105.9-19.2 106.4 36.6-.5z"
					fill="#fec74a"
					fillRule="evenodd"
					stroke="#d8aa3f"
					strokeWidth={1.6}
				/>
				<path
					d="m378.5 569.7-10.2-79-17.9 83.5 28.1-4.5z"
					fill="#fec74a"
					fillRule="evenodd"
					stroke="#d8aa3f"
					strokeWidth={1.3}
				...
				/>
				<path
					d="m407.2 249.3-77.9-65.8 55.4 94.1 22.5-28.3z"
					fill="#fec74a"
					fillRule="evenodd"
					stroke="#d8aa3f"
					strokeWidth={1.6}
