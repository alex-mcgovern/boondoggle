		...
		>
			<defs>
				<clipPath id="kg_svg__a">
					<path d="M104 0h416.3v416.3H104.1z" fillOpacity={0.7} />
				</clipPath>
			</defs>
			<g
				clipPath="url(#kg_svg__a)"
				fillRule="evenodd"
				transform="translate(-128) scale(1.23)"
			>
				<path d="M0 0h625v416.3H0z" fill="red" />
				<path
				...
				/>
				<path
					d="M393.4 208.2a80.7 80.7 0 1 1-161.3 0 80.7 80.7 0 0 1 161.3 0z"
					fill="#ff0"
				/>
				<path
				...
				/>
				<path
					d="M373.3 208.5a60.2 60.2 0 1 1-120.5 0 60.2 60.2 0 0 1 120.5 0z"
					fill="#ff0"
				/>
				<path
