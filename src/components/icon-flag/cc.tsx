...
export function FlagCc({
	...
	return (
		...
		>
			...
			<path d="M0 0h512v512H0z" fill="green" />
			<circle cx={268.2} cy={250.4} fill="#ffe000" r={61.2} />
			<circle cx={287.3} cy={250.4} fill="green" r={50.4} />
			<circle cx={75.2} cy={189.2} fill="#ffe000" r={64.2} />
			<path
