...
export function FlagGd({
	...
	return (
		...
		>
			...
			<path d="M71.7 71.7h368.6v368.6H71.7z" fill="#007a5e" />
			<path d="M71.7 71.7h368.6L71.7 440.4h368.6z" fill="#fcd116" />
			<circle cx={255.9} cy={256.1} fill="#ce1126" r={61.4} />
			<use
				height="100%"
