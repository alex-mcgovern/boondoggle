	...
	return (
		...
		>
			...
			<clipPath id="ai_svg__a">
				<path d="M0 0v128h298.7v128H256L0 0Zm256 0H128v298.7H0V256L256 0Z" />
			</clipPath>
			<path d="M0 0h512v512H0V0Z" fill="#012169" />
			<path d="m0 0 256 256m0-256L0 256" stroke="#fff" strokeWidth={50} />
			<path
				...
				strokeWidth={30}
			/>
			<path d="M128 0v298.7M0 128h298.7" stroke="#fff" strokeWidth={75} />
			<path
				d="M128 0v298.7M0 128h298.7"
				stroke="#c8102e"
				strokeWidth={50}
			/>
			<path d="M0 256h256V0h85.3v341.3H0V256Z" fill="#012169" />
			<path
