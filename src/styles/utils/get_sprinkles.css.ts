...
import { MEDIA_QUERY_DESKTOP, MEDIA_QUERY_TABLET } from "../common/media_queries.css";
...
export const sprinklesProperties = defineProperties({
    ...
    properties: {
        ...
        inset: ["0"],
        isolation: ["isolate"],
        justifyContent: ["stretch", "start", "center", "end", "space-around", "space-between"],
        left: ["0"],
...
export const getSprinkles = createSprinkles(sprinklesProperties, responsiveSprinklesProperties);
