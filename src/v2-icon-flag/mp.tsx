		...
		>
			<defs>
				<clipPath id="mp_svg__a">
					<path d="M248 0h496v496H248z" fillOpacity={0.7} />
				</clipPath>
			</defs>
			<g
				clipPath="url(#mp_svg__a)"
				transform="translate(-256) scale(1.0321)"
			>
				<path d="M0 0h992.1v496H0z" fill="#0071bc" fillRule="evenodd" />
				<path
				...
				/>
				<path
					d="M340.9 114.8s7.4 6.4 6 16c-1.4 9.6-6.9 22.9-5.8 32.8.7 4 .4 11.1.4 11.1s-6.6-9.4-6.7-19.5 7.2-19.7 7.2-27.2-1.3-13.3-1.1-13.2zm-3.7 2.9s-9.6 9.2-10.8 18.1c-1 4.6-1.3 26-1.4 35.6l-1.7 18.6c-.3 4.2 7-7.2 7.5-16.4a281 281 0 0 1 .7-32.7c.9-4 .7-8.3 2-12.2l3.7-11z"
					fill="#217900"
					fillRule="evenodd"
					stroke="#000"
				...
				/>
				<path
					d="M691.9 247.4s12.2 15.5 11.6 27.8c-.7 12.2-7.5 26.6-5.2 33-4-5.4-5-8.9-5.3-16.4-.3-7.5 6-15.8 4.8-24-1.3-8.2-6-20.4-6-20.4zm-401.4 3.4c-.5 7.7-6.2 14.6-3.3 28 3.8 15.1 17.2 34.4 15 56.5a33 33 0 0 0 5.5-19c.3-7.5-14.9-32.8-15.9-42.3 0-8.5-.8-20-1.3-23.2z"
					fill="#217900"
					fillRule="evenodd"
					stroke="#000"
					strokeLinejoin="round"
