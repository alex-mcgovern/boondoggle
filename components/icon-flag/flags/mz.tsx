	...
	return (
		...
		>
			...
			<g clipPath="url(#mz_svg__a)" transform="scale(1.0321)">
				<path d="M0 0h744v155H0z" fill="#009a00" fillRule="evenodd" />
				<path d="M0 155h744v15.5H0z" fill="#fff" fillRule="evenodd" />
				<path d="M0 170.5h744v155H0z" fillRule="evenodd" />
				<path d="M0 325.5h744V341H0z" fill="#fff" fillRule="evenodd" />
				<path d="M0 341h744v155H0z" fill="#ffca00" fillRule="evenodd" />
				<path
