"use client";
import { arrayHasLength } from "../../src/lib/array_has_length"; import { useDataTableState } from "../../src/lib/use_data_table_state"; import { Box } from "../box/Box"; import { DataTableActionsWrapper } from "./_components/DataTableActionsWrapper"; import { DataTableFilterInput } from "./_components/DataTableFilterInput"; import { DataTableInfoNoResults } from "./_components/DataTableInfoNoResults"; import { DataTableLayoutBody } from "./_components/DataTableLayoutBody"; import { DataTableLayoutHead } from "./_components/DataTableLayoutHead"; import { DataTablePaginationWrapper } from "./_components/DataTablePaginationWrapper"; import type { ColumnDef, RowData, SortingState } from "@tanstack/react-table"; import type { ReactNode } from "react"; import type {
	TDataTableRowActions,
	WithTableOptionalFiltering,
	WithTableOptionalPagination,
	WithTableOptionalSelectableRows,
} from "../../src/common-types"; import { table as tableCss } from "../../style.css";
