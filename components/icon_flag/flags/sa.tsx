...
export function FlagSa({
	...
	return (
		...
		>
			...
			>
				<path d="M0 0h744v496H0z" fill="#165d31" />
				<path
				...
				/>
				<path
					d="M383.8 183.8c-.5 1-2.3.9-4 0s-2.5-2.5-2-3.4 2.3-.9 4 0 2.5 2.5 2 3.4zM297.5 132c-1 .3-2.3-.6-2.9-2s-.3-2.5.7-2.8 2.3.7 2.9 2 .3 2.6-.7 2.8zm170.7 231.3c9 .4 17.6.1 26.6.6 1.7 1.3.5 4.8-.6 4.5l-7.6-.2c0-2.9-7.5-2.4-7.2.1-4 .5-7.6-.1-11.6-.3-1.2-1.5-1-4.1.4-4.7z"
					fill="#165d31"
				/>
			</g>
		</Box>
